...
1. Setup Ruby on your machine
2. Run `bundle install` in your terminal under this directory
3. Run `rake db:migrate` in your terminal under this directory
3. Execute the `run-webapp.sh` script by entering `./run-webapp.sh` into the terminal
